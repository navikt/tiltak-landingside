...
const veilederpanelSerializer = (panel: any) => {
...
const alertstripeSerializer = (alert: any) => {
...
const lesmerSerializer = (panel: any) => {
  return panel.node.innhold ? (
    <Lesmerpanel
      style={{ paddingTop: "0" }}
...
const enkeltknappSerializer = (props: any) => {
  const knapp = getButtonValues(props, "knappen");
  return <>{GetKnapp({ ...knapp })}</>;
};

const knapperSerializer = (props: any) => {
  const knapp = getButtonValues(props, "knappen");
...
const videoSerializer = (iframe: any) => {
...
const ekspanderbartpanelSerializer = (panel: any) => {
  return (
...
const fargeEditorSerializer = (panel: any) => {
...
export const getBlockContentFromList = (node: any[]) => (
  <>
...
const fargetTekstSerializer = (fargeTekst: any) => {
...
const whitespace = (innhold: any): React.ReactElement => (
  <>
